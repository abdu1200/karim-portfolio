...
const navigation = [
  ...
  { title: "Tech Stack", link: "stack", value: "02", delay: 0.2 },
  { title: "Experience", link: "experience", value: "03", delay: 0.3 },
  { title: "Education", link: "education", value: "04", delay: 0.4 },
  { title: "Projects", link: "project", value: "05", delay: 0.5 },
  { title: "Contact", link: "contact", value: "06", delay: 0.6 },
];
const Header = () => {
            ...
            >
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <motion.a
                  ...
                  href="mailto:abdukmom03@gmail.com"
                >
                  <p className="text-darkText hover:text-designColor hover:underline underline-offset-4 duration-200"></p>
                </motion.a>
              </div>
            </motion.div>
          </div>
